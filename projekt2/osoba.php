...
<?php
        ...
        echo"</dd>";
        echo"<dt><a href='klice.php?id=$employeeId'>Klíče:</a></dt><dd>";
        while ($row = $stmt2->fetch()) {
            echo"<a href='pokojj.php?room_id={$row->room}'>{$row->name}</a></br>";
        };
        echo"</dd>";
        echo"</dl>";
        echo "<a href='lidi.php'><span class='glyphicon glyphicon-arrow-left' aria-hidden='true'></span> Zpět na seznam zaměstnanců</a>     <a href='prehled.php'><span class='glyphicon glyphicon-home'></span></a>        ";
        }
