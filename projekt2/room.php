...
if($_SESSION['jeadm']==1){
    echo "<a href='room_add.php'class='btn btn-success '>Přidat</a></td>";
...
if($stmt->rowCount()==0){
    ...
    while($row=$stmt->fetch()){
        ...
        if($_SESSION['jeadm']==1){
            echo "<td><a href='update_r.php?id={$row->room_id}'class='btn btn-success'>Update</a>";
            echo "<a href='delete_r.php?id={$row->room_id}'class='btn btn-danger'"."onclick='return confirm(".'"Opravdu chces vymazat?"'.")'"." >Delete</a></td>";
        }else{
